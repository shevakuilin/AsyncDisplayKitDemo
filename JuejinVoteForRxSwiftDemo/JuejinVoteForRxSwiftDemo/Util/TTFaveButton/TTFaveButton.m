...
- (instancetype)initWithFrame:(CGRect)frame faveIconImage:(UIImage *)faveIconImage selectedFaveIconImage:(UIImage *)selectedFaveIconImage
{
    ...
    if (self) {
        ...
        self.normalColor = kColor(138, 147, 160);
        self.selectedColor = kColor(226, 38, 77);
        self.dotFirstColor = kColor(152, 219, 236);
        self.dotSecondColor = kColor(247, 188, 48);
        self.circleFromColor = kColor(221, 70, 136);
        self.circleToColor = kColor(205, 143, 246);
